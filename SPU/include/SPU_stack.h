...
#define ERROR_NAME(func)\
        func(STACK_NO_ERROR)\
        func(STACK_DATA_NULL_ERROR)\
        func(STACK_ELEM_NULL_ERROR)\
        func(STACK_STRUCT_NULL_ERROR)\
        func(STACK_NEGATIVE_SIZE_ERROR)\
        func(STACK_NEGATIVE_CAPACITY_ERROR)\
        func(STACK_SIZE_CAPACITY_ERROR)\
        func(STACK_MEMORY_ALLOCATION_ERROR)\
        func(STACK_POP_OUT_OF_RANGE_ERROR)\
        func(STACK_OPENING_FILE_ERROR)\
        func(STACK_CLOSING_FILE_ERROR)\
        func(STACK_DEAD_STRUCT_CANARY_ERROR)\
        func(STACK_DEAD_DATA_CANARY_ERROR)\
        func(STACK_UNREGISTERED_STRUCT_ACCESS_ERROR)\
        func(STACK_UNREGISTERED_DATA_ACCESS_ERROR)\
